...
<Callout title="Telemetry Collection" type="info">
  The telemetry collected consists of the current version, the os and the
  current total amount of songs in the local db. All of this is associated with
  a UUID generated upon the first startup of Vleer. This helps us identify the
  user democraphic and its interresting statistics available for everyone
  [here](https://graf.wireway.ch/public-dashboards/c518e42c7bc14c5ba95040671fb9e467).
</Callout>
